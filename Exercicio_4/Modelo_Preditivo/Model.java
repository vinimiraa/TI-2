...
public class Model
{
	public static void main(String[] Args)throws Exception
    {
		...
		HttpRequest req    = HttpRequest.newBuilder( )
						.uri(URI.create(url)).header("Content-Type","application/json").header("Authorization","Bearer eU42yooWtos3e8fVHnFoSIEGb762tSzj9D9c7d9rp2tQyFGfiTJ35QfFaWFNE9ld8ikAk7FPOb2d+AMC7Z7MJg==")
